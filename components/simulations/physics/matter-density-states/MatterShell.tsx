    ...
    <div className="flex flex-col w-full h-full min-h-[420px] bg-neutral-900 overflow-hidden rounded-xl ring-1 ring-cyan-500/15 shadow-[0_0_24px_-4px_rgba(34,211,238,0.08)]">
      <section className="flex flex-1 min-h-0 flex-col md:flex-row bg-neutral-900/95 rounded-xl overflow-hidden">
        <div className="w-full md:w-[65%] min-w-0 md:border-r border-neutral-600/80 flex flex-col p-3 overflow-hidden">
              ...
              <button
                ...
                className={`rounded-xl border px-3 py-2 text-xs font-semibold transition ${
                  hasLaunched
                    ...
                    : "border-cyan-500/40 bg-cyan-500/10 text-cyan-200 hover:bg-cyan-500/20 hover:shadow-[0_0_12px_-2px_rgba(34,211,238,0.3)]"
                }`}
              ...
              <button
                ...
                className={`rounded-xl px-3 py-2 text-xs font-semibold transition ${
                  !hasLaunched
                    ...
                    : paused
                    ? "bg-cyan-500 text-slate-950 hover:bg-cyan-400 shadow-[0_0_10px_-2px_rgba(34,211,238,0.4)]"
          ...
          <div className="relative flex-1 min-h-0 w-full rounded-xl border border-neutral-700 bg-[#050911] overflow-hidden flex flex-col">
            {children}
          </div>
...
export function SliderControl({
  ...
  const thumb = {
    ...
    magenta: "[&::-webkit-slider-thumb]:bg-fuchsia-400 [&::-webkit-slider-thumb]:ring-fuchsia-500/50",
  }[color];
  return (
    <div className="space-y-1.5">
      <div className="flex items-baseline justify-between">
        <label className="text-xs font-medium text-neutral-300" title={title}>
          {label}
        </label>
