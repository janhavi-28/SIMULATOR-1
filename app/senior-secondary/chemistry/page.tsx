...
import { chemistryChapters } from "@/app/subjects/class-11/chemistry/chapters-data";

export const metadata = {
  title: "Senior Secondary Chemistry | Illustrate.live",
  description: "Senior Secondary Chemistry – chapters and topics with interactive illustrations.",
};

export default function SeniorSecondaryChemistryPage() {
  return (
      ...
      <section className="mx-auto max-w-7xl px-6 pt-28 pb-24">
        ...
        <div className="mt-12 grid gap-6 md:grid-cols-2">
          {chemistryChapters.map((chapter) => (
            <Link
              key={chapter.id}
              href={`/senior-secondary/chemistry/${chapter.id}`}
