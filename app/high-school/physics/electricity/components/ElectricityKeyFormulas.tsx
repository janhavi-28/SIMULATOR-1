...
const FORMULAS = [
  {
    ...
    formula: "V = IR",
    icon: "⚡",
    short: "Ohm's law: voltage equals current times resistance.",
    meaning: {
      V: "Voltage (potential difference), in volts (V)",
      I: "Current, in amperes (A)",
      R: "Resistance, in ohms (Ω)",
    },
    usedInSim: "Voltage and Resistance sliders → Current display",
  },
  {
    id: "pvi",
    formula: "P = VI",
    icon: "🔥",
    short: "Electric power: rate at which energy is used.",
    meaning: {
      P: "Power, in watts (W)",
      V: "Voltage, in volts (V)",
      I: "Current, in amperes (A)",
    },
    usedInSim: "Live values: P = VI",
  },
  {
    id: "ept",
    formula: "E = Pt",
    icon: "📊",
    short: "Electrical energy: power times time (e.g. kWh).",
    meaning: {
      E: "Energy, in joules (J)",
      P: "Power, in watts (W)",
      t: "Time, in seconds (s)",
    },
    usedInSim: "E = Pt (since start) on canvas",
  },
] as const;

export default function ElectricityKeyFormulas() {
