...
const FORMULAS = [
  {
    ...
    formula: "v = fλ",
    icon: "📐",
    short: "Wave speed: frequency times wavelength.",
    meaning: {
      v: "Speed of light (or wave), in m/s",
      f: "Frequency, in Hz",
      λ: "Wavelength, in m",
    },
    usedInSim: "Refractive index in the sim relates to speed in the medium.",
  },
  {
    id: "lens",
    formula: "1/f = 1/v + 1/u",
    icon: "🔍",
    short: "Thin lens (or mirror) formula: object and image distances and focal length.",
    meaning: {
      f: "Focal length, in m",
      v: "Image distance, in m",
      u: "Object distance, in m",
    },
    usedInSim: "Lens and mirror simulators use this relationship.",
  },
  {
    id: "mag",
    formula: "m = hᵢ / h₀",
    icon: "📏",
    short: "Linear magnification: ratio of image height to object height.",
    meaning: {
      m: "Magnification (dimensionless)",
      "hᵢ": "Image height, in m",
      "h₀": "Object height, in m",
    },
    usedInSim: "Image size in ray diagrams relates to m.",
  },
] as const;

export default function LightKeyFormulas() {
  const [expandedId, setExpandedId] = useState<string | null>(null);
  const [hoverId, setHoverId] = useState<string | null>(null);

  return (
    <section className="w-full mb-8" aria-labelledby="light-key-formulas-heading">
      <h2 id="light-key-formulas-heading" className="text-xl font-semibold text-white mb-3">
        Key formulas
      </h2>
