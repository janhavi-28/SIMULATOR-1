...
const APPS = [
  {
    id: "mirrors",
    icon: "🚗",
    title: "Mirrors in vehicles",
    description: "Side and rear-view mirrors use reflection; convex mirrors give a wider field of view.",
    keyInsight: "Convex mirrors form virtual, diminished images so you see more area.",
  ...
  },
  {
    ...
    icon: "📷",
    title: "Cameras & eyes",
    description: "Lenses focus light onto a sensor or retina; object distance and focal length set the image.",
    keyInsight: "Real, inverted images form when the object is beyond the focal length.",
    cta: "Observe this using the simulator",
  },
  {
    id: "spectacles",
    icon: "👓",
    title: "Lenses in spectacles",
    description: "Convex lenses correct long sight; concave correct short sight by changing where light focuses.",
    keyInsight: "Refraction at curved surfaces bends light to form images.",
    cta: "Explore refraction in the simulator",
  },
] as const;

export default function LightRealWorldApps() {
  return (
    <section className="w-full mb-8" aria-labelledby="light-realworld-heading">
      <h2 id="light-realworld-heading" className="text-xl font-semibold text-white mb-3 flex items-center gap-2">
